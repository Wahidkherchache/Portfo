...
export default {
  ...
  theme: {
    extend: {
      colors: {
        ferrari: {
          red: "rgb(var(--ferrari-red) / <alpha-value>)",
          "red-dark": "rgb(var(--ferrari-red-dark) / <alpha-value>)",
          "red-bright": "rgb(var(--ferrari-red-bright) / <alpha-value>)",
          carbon: "rgb(var(--ferrari-carbon) / <alpha-value>)",
          carbon2: "rgb(var(--ferrari-carbon2) / <alpha-value>)",
          gold: "rgb(var(--ferrari-gold) / <alpha-value>)",
          "gold-bright": "rgb(var(--ferrari-gold-bright) / <alpha-value>)",
          smoke: "rgb(var(--ferrari-smoke) / <alpha-value>)",
          pit: "rgb(var(--ferrari-pit) / <alpha-value>)",
          "pit-light": "rgb(var(--ferrari-pit-light) / <alpha-value>)",
          "pit-border": "rgb(var(--ferrari-pit-border) / <alpha-value>)",
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        "red-glow":
          "0 0 24px rgba(220, 0, 0, 0.45), 0 0 60px rgba(220, 0, 0, 0.2)",
        "red-glow-lg":
